    ...
    <>
      <div className='container d-flex justify-content-center align-items-center vh-100'>
        ...
        <div className='container'>
          <p>{(formData.userName) ? formData.userName : "UserName"}</p>
          <p>{(formData.email) ? formData.email : "Email"}</p>
          <p>{(formData.password) ? formData.password : "Password"}</p>
          <p>{(formData.gender) ? formData.gender : "Gender"}</p>
          <p>{(formData.hobby) ? formData.hobby : "Hobby"}</p>
